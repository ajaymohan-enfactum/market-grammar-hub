    ...
    <SectionWrapper id="typography">
      ...
      <div className="grid grid-cols-2 gap-4 mb-10">
        <div className="bg-surface border border-border rounded-lg p-6">
          <div className="text-[10px] font-semibold tracking-[0.12em] uppercase text-muted mb-4">Primary Typeface (Latin + CJK)</div>
        ...
        <div className="bg-surface border border-border rounded-lg p-6">
          <div className="text-[10px] font-semibold tracking-[0.12em] uppercase text-muted mb-4">Mono Typeface (Data, Code, Metrics Only)</div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-10">
        <div>
          <h3 className="text-xs font-semibold tracking-[0.12em] uppercase text-muted mb-4">Type Scale</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold tracking-[0.12em] uppercase text-muted mb-4">Selective Word Highlighting</h3>
          <div className="bg-surface border border-border rounded-lg p-5">
            ...
            <div className="mb-4">
              <div className="text-[10px] font-semibold tracking-[0.12em] uppercase text-brand-emerald mb-2">✓ Correct</div>
            ...
            <div>
              <div className="text-[10px] font-semibold tracking-[0.12em] uppercase text-destructive mb-2">✗ Incorrect — Do not italicize</div>
              <p className="text-[28px] font-bold text-foreground leading-tight">
                Where markets meet{" "}
